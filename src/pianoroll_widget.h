...
public:
  PianorollCanvas(wxWindow *parent, wxWindowID id, const wxPoint &pos,
...
public:
  ControlChangeGraph(wxWindow *parent, wxWindowID id, const wxPoint &pos,
                     const wxSize &size, const wxString &name);
...
public:
  PianorollWidget(wxWindow *parent, wxWindowID id, const wxPoint &pos,
                  const wxSize &size, const wxString &name);
...
private:
  ...
  std::priority_queue<DrawCord, std::vector<DrawCord>, decltype(drawcord_comp)>
      *automation_drawed;
  ...
  // virtual void automation_draw_timeline(const Cairo::RefPtr<Cairo::Context>&
  // cr); virtual void automation_draw_graph(const
